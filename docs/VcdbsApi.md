...
<a name="createVcdbTags"></a>
# **createVcdbTags**
> TagsResponse createVcdbTags(vcdbId, tagsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    TagsRequest tagsRequest = new TagsRequest(); // TagsRequest | Tags information for vCDB.
    try {
      TagsResponse result = apiInstance.createVcdbTags(vcdbId, tagsRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VcdbsApi#createVcdbTags");
...
<a name="deleteVcdbTags"></a>
# **deleteVcdbTags**
> deleteVcdbTags(vcdbId, deleteTag)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteVcdbTags(vcdbId, deleteTag);
    } catch (ApiException e) {
      System.err.println("Exception when calling VcdbsApi#deleteVcdbTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getTagsVcdb"></a>
# **getTagsVcdb**
> TagsResponse getTagsVcdb(vcdbId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String vcdbId = "vcdbId_example"; // String | The ID of the vCDB.
    try {
      TagsResponse result = apiInstance.getTagsVcdb(vcdbId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VcdbsApi#getTagsVcdb");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getVcdbById"></a>
# **getVcdbById**
> VCDB getVcdbById(vcdbId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String vcdbId = "vcdbId_example"; // String | The ID of the vCDB.
    try {
      VCDB result = apiInstance.getVcdbById(vcdbId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VcdbsApi#getVcdbById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getVcdbs"></a>
# **getVcdbs**
> ListVCDBsResponse getVcdbs(limit, cursor, sort)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListVCDBsResponse result = apiInstance.getVcdbs(limit, cursor, sort);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VcdbsApi#getVcdbs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="searchVcdbs"></a>
# **searchVcdbs**
> SearchVCDBsResponse searchVcdbs(limit, cursor, sort, searchBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SearchVCDBsResponse result = apiInstance.searchVcdbs(limit, cursor, sort, searchBody);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VcdbsApi#searchVcdbs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
