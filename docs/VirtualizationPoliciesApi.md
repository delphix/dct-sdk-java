...
<a name="getVirtualizationPolicyById"></a>
...
<a name="listVirtualizationPolicies"></a>
 ...
 **sort** | **String**| The field to sort results by. A property name with a prepended &#39;-&#39; signifies a descending order. | [optional] [enum: id, -id, name, -name, engine_id, -engine_id, policy_type, -policy_type, timezone_id, -timezone_id]
...
<a name="searchVirtualizationPolicies"></a>
