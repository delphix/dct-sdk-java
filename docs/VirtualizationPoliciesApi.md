...
<a id="getVirtualizationPolicyById"></a>
# **getVirtualizationPolicyById**
> VirtualizationPolicy getVirtualizationPolicyById(policyId)
...
import com.delphix.dct.api.VirtualizationPoliciesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    VirtualizationPoliciesApi apiInstance = new VirtualizationPoliciesApi(defaultClient);
    String policyId = "policyId_example"; // String | The ID of the Virtualization Policy.
    try {
      VirtualizationPolicy result = apiInstance.getVirtualizationPolicyById(policyId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VirtualizationPoliciesApi#getVirtualizationPolicyById");
...
|-------------|-------------|------------------|
| **200** | Retuns a single virtualization policy |  -  |
| **404** | Virtualization policy not found |  -  |

<a id="listVirtualizationPolicies"></a>
# **listVirtualizationPolicies**
> ListVirtualizationPoliciesResponse listVirtualizationPolicies(limit, cursor, sort)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListVirtualizationPoliciesResponse result = apiInstance.listVirtualizationPolicies(limit, cursor, sort);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VirtualizationPoliciesApi#listVirtualizationPolicies");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **sort** | **String**| The field to sort results by. A property name with a prepended &#39;-&#39; signifies a descending order. | [optional] [enum: id, -id, name, -name, engine_id, -engine_id, policy_type, -policy_type, timezone_id, -timezone_id, default_policy, -default_policy, effective_type, -effective_type, data_duration, -data_duration, data_unit, -data_unit, log_duration, -log_duration, log_unit, -log_unit, num_of_daily, -num_of_daily, num_of_weekly, -num_of_weekly, day_of_week, -day_of_week, num_of_monthly, -num_of_monthly, day_of_month, -day_of_month, num_of_yearly, -num_of_yearly, day_of_year, -day_of_year, size, -size] |
...
<a id="searchVirtualizationPolicies"></a>
# **searchVirtualizationPolicies**
> SearchVirtualizationPoliciesResponse searchVirtualizationPolicies(limit, cursor, sort, searchBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SearchVirtualizationPoliciesResponse result = apiInstance.searchVirtualizationPolicies(limit, cursor, sort, searchBody);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling VirtualizationPoliciesApi#searchVirtualizationPolicies");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
