...
<a name="createDatabaseTemplate"></a>
# **createDatabaseTemplate**
> CreateDatabaseTemplateResponse createDatabaseTemplate(databaseTemplateCreateParameters)
...
import com.delphix.dct.api.DatabaseTemplatesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    DatabaseTemplatesApi apiInstance = new DatabaseTemplatesApi(defaultClient);
    DatabaseTemplateCreateParameters databaseTemplateCreateParameters = new DatabaseTemplateCreateParameters(); // DatabaseTemplateCreateParameters | The parameters to create a database template.
    try {
      CreateDatabaseTemplateResponse result = apiInstance.createDatabaseTemplate(databaseTemplateCreateParameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#createDatabaseTemplate");
...
<a name="createDatabaseTemplateTags"></a>
# **createDatabaseTemplateTags**
> TagsResponse createDatabaseTemplateTags(databaseTemplateId, tagsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    DatabaseTemplatesApi apiInstance = new DatabaseTemplatesApi(defaultClient);
    String databaseTemplateId = "databaseTemplateId_example"; // String | The ID of the Database Template.
    TagsRequest tagsRequest = new TagsRequest(); // TagsRequest | Tags information for a DatabaseTemplate.
    try {
      TagsResponse result = apiInstance.createDatabaseTemplateTags(databaseTemplateId, tagsRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#createDatabaseTemplateTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="deleteDatabaseTemplate"></a>
# **deleteDatabaseTemplate**
> DeleteDatabaseTemplateResponse deleteDatabaseTemplate(databaseTemplateId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String databaseTemplateId = "databaseTemplateId_example"; // String | The ID of the Database Template.
    try {
      DeleteDatabaseTemplateResponse result = apiInstance.deleteDatabaseTemplate(databaseTemplateId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#deleteDatabaseTemplate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | DatabaseTemplate delete initiated. |  -  |

<a name="deleteDatabaseTemplateTag"></a>
# **deleteDatabaseTemplateTag**
> deleteDatabaseTemplateTag(databaseTemplateId, deleteTag)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteDatabaseTemplateTag(databaseTemplateId, deleteTag);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#deleteDatabaseTemplateTag");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getDatabaseTemplateById"></a>
# **getDatabaseTemplateById**
> DatabaseTemplate getDatabaseTemplateById(databaseTemplateId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String databaseTemplateId = "databaseTemplateId_example"; // String | The ID of the Database Template.
    try {
      DatabaseTemplate result = apiInstance.getDatabaseTemplateById(databaseTemplateId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#getDatabaseTemplateById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getDatabaseTemplateTags"></a>
# **getDatabaseTemplateTags**
> TagsResponse getDatabaseTemplateTags(databaseTemplateId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String databaseTemplateId = "databaseTemplateId_example"; // String | The ID of the Database Template.
    try {
      TagsResponse result = apiInstance.getDatabaseTemplateTags(databaseTemplateId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#getDatabaseTemplateTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="getDatabaseTemplates"></a>
# **getDatabaseTemplates**
> ListDatabaseTemplatesResponse getDatabaseTemplates(limit, cursor, sort)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListDatabaseTemplatesResponse result = apiInstance.getDatabaseTemplates(limit, cursor, sort);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#getDatabaseTemplates");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
 ...
 **sort** | **String**| The field to sort results by. A property name with a prepended &#39;-&#39; signifies descending order. | [optional] [enum: id, -id, name, -name, description, -description, source_type, -source_type]
...
<a name="importDatabaseTemplates"></a>
# **importDatabaseTemplates**
> importDatabaseTemplates(engineIdBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.importDatabaseTemplates(engineIdBody);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#importDatabaseTemplates");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="searchDatabaseTemplates"></a>
# **searchDatabaseTemplates**
> SearchDatabaseTemplatesResponse searchDatabaseTemplates(limit, cursor, sort, searchBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SearchDatabaseTemplatesResponse result = apiInstance.searchDatabaseTemplates(limit, cursor, sort, searchBody);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#searchDatabaseTemplates");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="undoImportDatabaseTemplates"></a>
# **undoImportDatabaseTemplates**
> undoImportDatabaseTemplates(engineIdBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    EngineIdBody engineIdBody = new EngineIdBody(); // EngineIdBody | Body containing the ID of the registered engine.
    try {
      apiInstance.undoImportDatabaseTemplates(engineIdBody);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#undoImportDatabaseTemplates");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="updateDatabaseTemplate"></a>
# **updateDatabaseTemplate**
> UpdateDatabaseTemplateResponse updateDatabaseTemplate(databaseTemplateId, updateDatabaseTemplateParameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    DatabaseTemplatesApi apiInstance = new DatabaseTemplatesApi(defaultClient);
    String databaseTemplateId = "databaseTemplateId_example"; // String | The ID of the Database Template.
    UpdateDatabaseTemplateParameters updateDatabaseTemplateParameters = new UpdateDatabaseTemplateParameters(); // UpdateDatabaseTemplateParameters | The new data to update a VDB.
    try {
      UpdateDatabaseTemplateResponse result = apiInstance.updateDatabaseTemplate(databaseTemplateId, updateDatabaseTemplateParameters);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DatabaseTemplatesApi#updateDatabaseTemplate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
------------- | ------------- | ------------- | -------------
 **databaseTemplateId** | **String**| The ID of the Database Template. |
 **updateDatabaseTemplateParameters** | [**UpdateDatabaseTemplateParameters**](UpdateDatabaseTemplateParameters.md)| The new data to update a VDB. | [optional]
