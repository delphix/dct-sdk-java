...
public class Example {
  public static void main(String[] args) {
    ...
    SnapshotsApi apiInstance = new SnapshotsApi(defaultClient);
    String datasetId = "dataset-123"; // String | The ID of the dSource or VDB.
    OffsetDateTime timestamp = OffsetDateTime.now(); // OffsetDateTime | The desired point in time.
    try {
...
<a name="getSnapshotTimeflowRange"></a>
...
<a name="unsetSnapshotRetention"></a>
