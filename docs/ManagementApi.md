...
> UpdateEngineAutoTaggingConfigResponse updateEngineAutoTaggingConfig(engineId, engineAutoTaggingConfigUpdateParameters)
...
public class Example {
  public static void main(String[] args) {
    ...
    ManagementApi apiInstance = new ManagementApi(defaultClient);
    String engineId = "engineId_example"; // String | The ID of the registered engine.
    EngineAutoTaggingConfigUpdateParameters engineAutoTaggingConfigUpdateParameters = new EngineAutoTaggingConfigUpdateParameters(); // EngineAutoTaggingConfigUpdateParameters | The auto tagging config update parameters.
    try {
      UpdateEngineAutoTaggingConfigResponse result = apiInstance.updateEngineAutoTaggingConfig(engineId, engineAutoTaggingConfigUpdateParameters);
      System.out.println(result);
    } catch (ApiException e) {
...
|------------- | ------------- | ------------- | -------------|
| **engineId** | **String**| The ID of the registered engine. | |
| **engineAutoTaggingConfigUpdateParameters** | [**EngineAutoTaggingConfigUpdateParameters**](EngineAutoTaggingConfigUpdateParameters.md)| The auto tagging config update parameters. | |
