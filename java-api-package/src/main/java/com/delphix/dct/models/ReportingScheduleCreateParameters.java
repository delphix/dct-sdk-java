...
public class ReportingScheduleCreateParameters {
  ...
  public ReportingScheduleCreateParameters() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ReportingScheduleCreateParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportingScheduleCreateParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportingScheduleCreateParameters is not found in the empty JSON string", ReportingScheduleCreateParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportingScheduleCreateParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportingScheduleCreateParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportingScheduleCreateParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportingScheduleCreateParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportingScheduleCreateParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportingScheduleCreateParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportingScheduleCreateParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportingScheduleCreateParameters>() {
           @Override
           public void write(JsonWriter out, ReportingScheduleCreateParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportingScheduleCreateParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReportingScheduleCreateParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReportingScheduleCreateParameters
  * @throws IOException if the JSON string is invalid with respect to ReportingScheduleCreateParameters
  */
  public static ReportingScheduleCreateParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportingScheduleCreateParameters.class);
  }

 /**
  * Convert an instance of ReportingScheduleCreateParameters to an JSON string
  *
  * @return JSON string
  */
