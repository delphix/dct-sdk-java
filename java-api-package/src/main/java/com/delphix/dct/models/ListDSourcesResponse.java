...
public class ListDSourcesResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ListDSourcesResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDSourcesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListDSourcesResponse is not found in the empty JSON string", ListDSourcesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDSourcesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListDSourcesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDSourcesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDSourcesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDSourcesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDSourcesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDSourcesResponse>() {
           @Override
           public void write(JsonWriter out, ListDSourcesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDSourcesResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListDSourcesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListDSourcesResponse
  * @throws IOException if the JSON string is invalid with respect to ListDSourcesResponse
  */
  public static ListDSourcesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDSourcesResponse.class);
  }

 /**
  * Convert an instance of ListDSourcesResponse to an JSON string
  *
  * @return JSON string
  */
