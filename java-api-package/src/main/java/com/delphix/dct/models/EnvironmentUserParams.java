...
public class EnvironmentUserParams {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EnvironmentUserParams
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnvironmentUserParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnvironmentUserParams is not found in the empty JSON string", EnvironmentUserParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnvironmentUserParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnvironmentUserParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnvironmentUserParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnvironmentUserParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnvironmentUserParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnvironmentUserParams.class));

       return (TypeAdapter<T>) new TypeAdapter<EnvironmentUserParams>() {
           @Override
           public void write(JsonWriter out, EnvironmentUserParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnvironmentUserParams read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EnvironmentUserParams given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EnvironmentUserParams
  * @throws IOException if the JSON string is invalid with respect to EnvironmentUserParams
  */
  public static EnvironmentUserParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnvironmentUserParams.class);
  }

 /**
  * Convert an instance of EnvironmentUserParams to an JSON string
  *
  * @return JSON string
  */
