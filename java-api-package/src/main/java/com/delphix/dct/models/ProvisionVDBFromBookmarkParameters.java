...
public class ProvisionVDBFromBookmarkParameters {
  ...
  public ProvisionVDBFromBookmarkParameters() {
  }

  public ProvisionVDBFromBookmarkParameters preRefresh(List<Hook> preRefresh) {
    this.preRefresh = preRefresh;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPreRefreshItem(Hook preRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters postRefresh(List<Hook> postRefresh) {
    this.postRefresh = postRefresh;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPostRefreshItem(Hook postRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters preSelfRefresh(List<Hook> preSelfRefresh) {
    this.preSelfRefresh = preSelfRefresh;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPreSelfRefreshItem(Hook preSelfRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters postSelfRefresh(List<Hook> postSelfRefresh) {
    this.postSelfRefresh = postSelfRefresh;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPostSelfRefreshItem(Hook postSelfRefreshItem) {
  ...
  **/
  ...
  @Deprecated
  public ProvisionVDBFromBookmarkParameters preRollback(List<Hook> preRollback) {
    this.preRollback = preRollback;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPreRollbackItem(Hook preRollbackItem) {
  ...
  **/
  ...
  @Deprecated
  public ProvisionVDBFromBookmarkParameters postRollback(List<Hook> postRollback) {
    this.postRollback = postRollback;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPostRollbackItem(Hook postRollbackItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters configureClone(List<Hook> configureClone) {
    this.configureClone = configureClone;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addConfigureCloneItem(Hook configureCloneItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters preSnapshot(List<Hook> preSnapshot) {
    this.preSnapshot = preSnapshot;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPreSnapshotItem(Hook preSnapshotItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters postSnapshot(List<Hook> postSnapshot) {
    this.postSnapshot = postSnapshot;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPostSnapshotItem(Hook postSnapshotItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters preStart(List<Hook> preStart) {
    this.preStart = preStart;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPreStartItem(Hook preStartItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters postStart(List<Hook> postStart) {
    this.postStart = postStart;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPostStartItem(Hook postStartItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters preStop(List<Hook> preStop) {
    this.preStop = preStop;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPreStopItem(Hook preStopItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters postStop(List<Hook> postStop) {
    this.postStop = postStop;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addPostStopItem(Hook postStopItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters targetGroupId(String targetGroupId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters databaseName(String databaseName) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters cdbId(String cdbId) {
    this.cdbId = cdbId;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters clusterNodeIds(List<String> clusterNodeIds) {
    this.clusterNodeIds = clusterNodeIds;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addClusterNodeIdsItem(String clusterNodeIdsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters clusterNodeInstances(List<ClusterNodeInstance> clusterNodeInstances) {
    this.clusterNodeInstances = clusterNodeInstances;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addClusterNodeInstancesItem(ClusterNodeInstance clusterNodeInstancesItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters truncateLogOnCheckpoint(Boolean truncateLogOnCheckpoint) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters osUsername(String osUsername) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters osPassword(String osPassword) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters environmentId(String environmentId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters environmentUserId(String environmentUserId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters repositoryId(String repositoryId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters autoSelectRepository(Boolean autoSelectRepository) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters vdbRestart(Boolean vdbRestart) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters templateId(String templateId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters auxiliaryTemplateId(String auxiliaryTemplateId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters fileMappingRules(String fileMappingRules) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters oracleInstanceName(String oracleInstanceName) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters uniqueName(String uniqueName) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters vcdbName(String vcdbName) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters vcdbDatabaseName(String vcdbDatabaseName) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters mountPoint(String mountPoint) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters openResetLogs(Boolean openResetLogs) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters snapshotPolicyId(String snapshotPolicyId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters retentionPolicyId(String retentionPolicyId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters recoveryModel(RecoveryModelEnum recoveryModel) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters preScript(String preScript) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters postScript(String postScript) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters cdcOnProvision(Boolean cdcOnProvision) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters onlineLogSize(Integer onlineLogSize) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters onlineLogGroups(Integer onlineLogGroups) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters archiveLog(Boolean archiveLog) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters newDbid(Boolean newDbid) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters masked(Boolean masked) {
    this.masked = masked;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters listenerIds(List<String> listenerIds) {
    this.listenerIds = listenerIds;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addListenerIdsItem(String listenerIdsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters customEnvVars(Map<String, String> customEnvVars) {
    this.customEnvVars = customEnvVars;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters putCustomEnvVarsItem(String key, String customEnvVarsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters customEnvFiles(List<String> customEnvFiles) {
    this.customEnvFiles = customEnvFiles;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addCustomEnvFilesItem(String customEnvFilesItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters oracleRacCustomEnvFiles(List<OracleRacCustomEnvFile> oracleRacCustomEnvFiles) {
    this.oracleRacCustomEnvFiles = oracleRacCustomEnvFiles;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addOracleRacCustomEnvFilesItem(OracleRacCustomEnvFile oracleRacCustomEnvFilesItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters oracleRacCustomEnvVars(List<OracleRacCustomEnvVar> oracleRacCustomEnvVars) {
    this.oracleRacCustomEnvVars = oracleRacCustomEnvVars;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addOracleRacCustomEnvVarsItem(OracleRacCustomEnvVar oracleRacCustomEnvVarsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters parentTdeKeystorePath(String parentTdeKeystorePath) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters parentTdeKeystorePassword(String parentTdeKeystorePassword) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters tdeExportedKeyFileSecret(String tdeExportedKeyFileSecret) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters tdeKeyIdentifier(String tdeKeyIdentifier) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters targetVcdbTdeKeystorePath(String targetVcdbTdeKeystorePath) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters cdbTdeKeystorePassword(String cdbTdeKeystorePassword) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters vcdbTdeKeyIdentifier(String vcdbTdeKeyIdentifier) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters appdataSourceParams(Map<String, Object> appdataSourceParams) {
    this.appdataSourceParams = appdataSourceParams;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters putAppdataSourceParamsItem(String key, Object appdataSourceParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters additionalMountPoints(List<AdditionalMountPoint> additionalMountPoints) {
    this.additionalMountPoints = additionalMountPoints;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addAdditionalMountPointsItem(AdditionalMountPoint additionalMountPointsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters appdataConfigParams(Map<String, Object> appdataConfigParams) {
    this.appdataConfigParams = appdataConfigParams;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters putAppdataConfigParamsItem(String key, Object appdataConfigParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters configParams(Map<String, Object> configParams) {
    this.configParams = configParams;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters putConfigParamsItem(String key, Object configParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters privilegedOsUser(String privilegedOsUser) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters postgresPort(Integer postgresPort) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters configSettingsStg(List<ConfigSettingsStg> configSettingsStg) {
    this.configSettingsStg = configSettingsStg;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addConfigSettingsStgItem(ConfigSettingsStg configSettingsStgItem) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters vcdbRestart(Boolean vcdbRestart) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters mssqlFailoverDriveLetter(String mssqlFailoverDriveLetter) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public ProvisionVDBFromBookmarkParameters addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters bookmarkId(String bookmarkId) {
  ...
  **/
  ...
  public ProvisionVDBFromBookmarkParameters makeCurrentAccountOwner(Boolean makeCurrentAccountOwner) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProvisionVDBFromBookmarkParameters provisionVDBFromBookmarkParameters = (ProvisionVDBFromBookmarkParameters) o;
    return Objects.equals(this.preRefresh, provisionVDBFromBookmarkParameters.preRefresh) &&
        Objects.equals(this.postRefresh, provisionVDBFromBookmarkParameters.postRefresh) &&
        Objects.equals(this.preSelfRefresh, provisionVDBFromBookmarkParameters.preSelfRefresh) &&
        Objects.equals(this.postSelfRefresh, provisionVDBFromBookmarkParameters.postSelfRefresh) &&
        Objects.equals(this.preRollback, provisionVDBFromBookmarkParameters.preRollback) &&
        Objects.equals(this.postRollback, provisionVDBFromBookmarkParameters.postRollback) &&
        Objects.equals(this.configureClone, provisionVDBFromBookmarkParameters.configureClone) &&
        Objects.equals(this.preSnapshot, provisionVDBFromBookmarkParameters.preSnapshot) &&
        Objects.equals(this.postSnapshot, provisionVDBFromBookmarkParameters.postSnapshot) &&
        Objects.equals(this.preStart, provisionVDBFromBookmarkParameters.preStart) &&
        Objects.equals(this.postStart, provisionVDBFromBookmarkParameters.postStart) &&
        Objects.equals(this.preStop, provisionVDBFromBookmarkParameters.preStop) &&
        Objects.equals(this.postStop, provisionVDBFromBookmarkParameters.postStop) &&
        Objects.equals(this.targetGroupId, provisionVDBFromBookmarkParameters.targetGroupId) &&
        Objects.equals(this.name, provisionVDBFromBookmarkParameters.name) &&
        Objects.equals(this.databaseName, provisionVDBFromBookmarkParameters.databaseName) &&
        Objects.equals(this.cdbId, provisionVDBFromBookmarkParameters.cdbId) &&
        Objects.equals(this.clusterNodeIds, provisionVDBFromBookmarkParameters.clusterNodeIds) &&
        Objects.equals(this.clusterNodeInstances, provisionVDBFromBookmarkParameters.clusterNodeInstances) &&
        Objects.equals(this.truncateLogOnCheckpoint, provisionVDBFromBookmarkParameters.truncateLogOnCheckpoint) &&
        Objects.equals(this.osUsername, provisionVDBFromBookmarkParameters.osUsername) &&
        Objects.equals(this.osPassword, provisionVDBFromBookmarkParameters.osPassword) &&
        Objects.equals(this.environmentId, provisionVDBFromBookmarkParameters.environmentId) &&
        Objects.equals(this.environmentUserId, provisionVDBFromBookmarkParameters.environmentUserId) &&
        Objects.equals(this.repositoryId, provisionVDBFromBookmarkParameters.repositoryId) &&
        Objects.equals(this.autoSelectRepository, provisionVDBFromBookmarkParameters.autoSelectRepository) &&
        Objects.equals(this.vdbRestart, provisionVDBFromBookmarkParameters.vdbRestart) &&
        Objects.equals(this.templateId, provisionVDBFromBookmarkParameters.templateId) &&
        Objects.equals(this.auxiliaryTemplateId, provisionVDBFromBookmarkParameters.auxiliaryTemplateId) &&
        Objects.equals(this.fileMappingRules, provisionVDBFromBookmarkParameters.fileMappingRules) &&
        Objects.equals(this.oracleInstanceName, provisionVDBFromBookmarkParameters.oracleInstanceName) &&
        Objects.equals(this.uniqueName, provisionVDBFromBookmarkParameters.uniqueName) &&
        Objects.equals(this.vcdbName, provisionVDBFromBookmarkParameters.vcdbName) &&
        Objects.equals(this.vcdbDatabaseName, provisionVDBFromBookmarkParameters.vcdbDatabaseName) &&
        Objects.equals(this.mountPoint, provisionVDBFromBookmarkParameters.mountPoint) &&
        Objects.equals(this.openResetLogs, provisionVDBFromBookmarkParameters.openResetLogs) &&
        Objects.equals(this.snapshotPolicyId, provisionVDBFromBookmarkParameters.snapshotPolicyId) &&
        Objects.equals(this.retentionPolicyId, provisionVDBFromBookmarkParameters.retentionPolicyId) &&
        Objects.equals(this.recoveryModel, provisionVDBFromBookmarkParameters.recoveryModel) &&
        Objects.equals(this.preScript, provisionVDBFromBookmarkParameters.preScript) &&
        Objects.equals(this.postScript, provisionVDBFromBookmarkParameters.postScript) &&
        Objects.equals(this.cdcOnProvision, provisionVDBFromBookmarkParameters.cdcOnProvision) &&
        Objects.equals(this.onlineLogSize, provisionVDBFromBookmarkParameters.onlineLogSize) &&
        Objects.equals(this.onlineLogGroups, provisionVDBFromBookmarkParameters.onlineLogGroups) &&
        Objects.equals(this.archiveLog, provisionVDBFromBookmarkParameters.archiveLog) &&
        Objects.equals(this.newDbid, provisionVDBFromBookmarkParameters.newDbid) &&
        Objects.equals(this.masked, provisionVDBFromBookmarkParameters.masked) &&
        Objects.equals(this.listenerIds, provisionVDBFromBookmarkParameters.listenerIds) &&
        Objects.equals(this.customEnvVars, provisionVDBFromBookmarkParameters.customEnvVars) &&
        Objects.equals(this.customEnvFiles, provisionVDBFromBookmarkParameters.customEnvFiles) &&
        Objects.equals(this.oracleRacCustomEnvFiles, provisionVDBFromBookmarkParameters.oracleRacCustomEnvFiles) &&
        Objects.equals(this.oracleRacCustomEnvVars, provisionVDBFromBookmarkParameters.oracleRacCustomEnvVars) &&
        Objects.equals(this.parentTdeKeystorePath, provisionVDBFromBookmarkParameters.parentTdeKeystorePath) &&
        Objects.equals(this.parentTdeKeystorePassword, provisionVDBFromBookmarkParameters.parentTdeKeystorePassword) &&
        Objects.equals(this.tdeExportedKeyFileSecret, provisionVDBFromBookmarkParameters.tdeExportedKeyFileSecret) &&
        Objects.equals(this.tdeKeyIdentifier, provisionVDBFromBookmarkParameters.tdeKeyIdentifier) &&
        Objects.equals(this.targetVcdbTdeKeystorePath, provisionVDBFromBookmarkParameters.targetVcdbTdeKeystorePath) &&
        Objects.equals(this.cdbTdeKeystorePassword, provisionVDBFromBookmarkParameters.cdbTdeKeystorePassword) &&
        Objects.equals(this.vcdbTdeKeyIdentifier, provisionVDBFromBookmarkParameters.vcdbTdeKeyIdentifier) &&
        Objects.equals(this.appdataSourceParams, provisionVDBFromBookmarkParameters.appdataSourceParams) &&
        Objects.equals(this.additionalMountPoints, provisionVDBFromBookmarkParameters.additionalMountPoints) &&
        Objects.equals(this.appdataConfigParams, provisionVDBFromBookmarkParameters.appdataConfigParams) &&
        Objects.equals(this.configParams, provisionVDBFromBookmarkParameters.configParams) &&
        Objects.equals(this.privilegedOsUser, provisionVDBFromBookmarkParameters.privilegedOsUser) &&
        Objects.equals(this.postgresPort, provisionVDBFromBookmarkParameters.postgresPort) &&
        Objects.equals(this.configSettingsStg, provisionVDBFromBookmarkParameters.configSettingsStg) &&
        Objects.equals(this.vcdbRestart, provisionVDBFromBookmarkParameters.vcdbRestart) &&
        Objects.equals(this.mssqlFailoverDriveLetter, provisionVDBFromBookmarkParameters.mssqlFailoverDriveLetter) &&
        Objects.equals(this.tags, provisionVDBFromBookmarkParameters.tags) &&
        Objects.equals(this.bookmarkId, provisionVDBFromBookmarkParameters.bookmarkId) &&
        Objects.equals(this.makeCurrentAccountOwner, provisionVDBFromBookmarkParameters.makeCurrentAccountOwner);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvisionVDBFromBookmarkParameters {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProvisionVDBFromBookmarkParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionVDBFromBookmarkParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisionVDBFromBookmarkParameters is not found in the empty JSON string", ProvisionVDBFromBookmarkParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionVDBFromBookmarkParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisionVDBFromBookmarkParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProvisionVDBFromBookmarkParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisionVDBFromBookmarkParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisionVDBFromBookmarkParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisionVDBFromBookmarkParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisionVDBFromBookmarkParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisionVDBFromBookmarkParameters>() {
           @Override
           public void write(JsonWriter out, ProvisionVDBFromBookmarkParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisionVDBFromBookmarkParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProvisionVDBFromBookmarkParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProvisionVDBFromBookmarkParameters
  * @throws IOException if the JSON string is invalid with respect to ProvisionVDBFromBookmarkParameters
  */
  public static ProvisionVDBFromBookmarkParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisionVDBFromBookmarkParameters.class);
  }

 /**
  * Convert an instance of ProvisionVDBFromBookmarkParameters to an JSON string
  *
  * @return JSON string
  */
