...
public class ProvisionVDBByTimestampParameters {
  ...
  public ProvisionVDBByTimestampParameters() {
  }

  public ProvisionVDBByTimestampParameters preRefresh(List<Hook> preRefresh) {
    this.preRefresh = preRefresh;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPreRefreshItem(Hook preRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters postRefresh(List<Hook> postRefresh) {
    this.postRefresh = postRefresh;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPostRefreshItem(Hook postRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters preSelfRefresh(List<Hook> preSelfRefresh) {
    this.preSelfRefresh = preSelfRefresh;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPreSelfRefreshItem(Hook preSelfRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters postSelfRefresh(List<Hook> postSelfRefresh) {
    this.postSelfRefresh = postSelfRefresh;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPostSelfRefreshItem(Hook postSelfRefreshItem) {
  ...
  **/
  ...
  @Deprecated
  public ProvisionVDBByTimestampParameters preRollback(List<Hook> preRollback) {
    this.preRollback = preRollback;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPreRollbackItem(Hook preRollbackItem) {
  ...
  **/
  ...
  @Deprecated
  public ProvisionVDBByTimestampParameters postRollback(List<Hook> postRollback) {
    this.postRollback = postRollback;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPostRollbackItem(Hook postRollbackItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters configureClone(List<Hook> configureClone) {
    this.configureClone = configureClone;
    return this;
  }

  public ProvisionVDBByTimestampParameters addConfigureCloneItem(Hook configureCloneItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters preSnapshot(List<Hook> preSnapshot) {
    this.preSnapshot = preSnapshot;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPreSnapshotItem(Hook preSnapshotItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters postSnapshot(List<Hook> postSnapshot) {
    this.postSnapshot = postSnapshot;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPostSnapshotItem(Hook postSnapshotItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters preStart(List<Hook> preStart) {
    this.preStart = preStart;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPreStartItem(Hook preStartItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters postStart(List<Hook> postStart) {
    this.postStart = postStart;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPostStartItem(Hook postStartItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters preStop(List<Hook> preStop) {
    this.preStop = preStop;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPreStopItem(Hook preStopItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters postStop(List<Hook> postStop) {
    this.postStop = postStop;
    return this;
  }

  public ProvisionVDBByTimestampParameters addPostStopItem(Hook postStopItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters targetGroupId(String targetGroupId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters databaseName(String databaseName) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters cdbId(String cdbId) {
    this.cdbId = cdbId;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters clusterNodeIds(List<String> clusterNodeIds) {
    this.clusterNodeIds = clusterNodeIds;
    return this;
  }

  public ProvisionVDBByTimestampParameters addClusterNodeIdsItem(String clusterNodeIdsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters clusterNodeInstances(List<ClusterNodeInstance> clusterNodeInstances) {
    this.clusterNodeInstances = clusterNodeInstances;
    return this;
  }

  public ProvisionVDBByTimestampParameters addClusterNodeInstancesItem(ClusterNodeInstance clusterNodeInstancesItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters truncateLogOnCheckpoint(Boolean truncateLogOnCheckpoint) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters osUsername(String osUsername) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters osPassword(String osPassword) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters environmentId(String environmentId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters environmentUserId(String environmentUserId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters repositoryId(String repositoryId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters autoSelectRepository(Boolean autoSelectRepository) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters vdbRestart(Boolean vdbRestart) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters templateId(String templateId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters auxiliaryTemplateId(String auxiliaryTemplateId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters fileMappingRules(String fileMappingRules) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters oracleInstanceName(String oracleInstanceName) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters uniqueName(String uniqueName) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters vcdbName(String vcdbName) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters vcdbDatabaseName(String vcdbDatabaseName) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters mountPoint(String mountPoint) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters openResetLogs(Boolean openResetLogs) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters snapshotPolicyId(String snapshotPolicyId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters retentionPolicyId(String retentionPolicyId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters recoveryModel(RecoveryModelEnum recoveryModel) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters preScript(String preScript) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters postScript(String postScript) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters cdcOnProvision(Boolean cdcOnProvision) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters onlineLogSize(Integer onlineLogSize) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters onlineLogGroups(Integer onlineLogGroups) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters archiveLog(Boolean archiveLog) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters newDbid(Boolean newDbid) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters masked(Boolean masked) {
    this.masked = masked;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters listenerIds(List<String> listenerIds) {
    this.listenerIds = listenerIds;
    return this;
  }

  public ProvisionVDBByTimestampParameters addListenerIdsItem(String listenerIdsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters customEnvVars(Map<String, String> customEnvVars) {
    this.customEnvVars = customEnvVars;
    return this;
  }

  public ProvisionVDBByTimestampParameters putCustomEnvVarsItem(String key, String customEnvVarsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters customEnvFiles(List<String> customEnvFiles) {
    this.customEnvFiles = customEnvFiles;
    return this;
  }

  public ProvisionVDBByTimestampParameters addCustomEnvFilesItem(String customEnvFilesItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters oracleRacCustomEnvFiles(List<OracleRacCustomEnvFile> oracleRacCustomEnvFiles) {
    this.oracleRacCustomEnvFiles = oracleRacCustomEnvFiles;
    return this;
  }

  public ProvisionVDBByTimestampParameters addOracleRacCustomEnvFilesItem(OracleRacCustomEnvFile oracleRacCustomEnvFilesItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters oracleRacCustomEnvVars(List<OracleRacCustomEnvVar> oracleRacCustomEnvVars) {
    this.oracleRacCustomEnvVars = oracleRacCustomEnvVars;
    return this;
  }

  public ProvisionVDBByTimestampParameters addOracleRacCustomEnvVarsItem(OracleRacCustomEnvVar oracleRacCustomEnvVarsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters parentTdeKeystorePath(String parentTdeKeystorePath) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters parentTdeKeystorePassword(String parentTdeKeystorePassword) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters tdeExportedKeyFileSecret(String tdeExportedKeyFileSecret) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters tdeKeyIdentifier(String tdeKeyIdentifier) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters targetVcdbTdeKeystorePath(String targetVcdbTdeKeystorePath) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters cdbTdeKeystorePassword(String cdbTdeKeystorePassword) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters vcdbTdeKeyIdentifier(String vcdbTdeKeyIdentifier) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters appdataSourceParams(Map<String, Object> appdataSourceParams) {
    this.appdataSourceParams = appdataSourceParams;
    return this;
  }

  public ProvisionVDBByTimestampParameters putAppdataSourceParamsItem(String key, Object appdataSourceParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters additionalMountPoints(List<AdditionalMountPoint> additionalMountPoints) {
    this.additionalMountPoints = additionalMountPoints;
    return this;
  }

  public ProvisionVDBByTimestampParameters addAdditionalMountPointsItem(AdditionalMountPoint additionalMountPointsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters appdataConfigParams(Map<String, Object> appdataConfigParams) {
    this.appdataConfigParams = appdataConfigParams;
    return this;
  }

  public ProvisionVDBByTimestampParameters putAppdataConfigParamsItem(String key, Object appdataConfigParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters configParams(Map<String, Object> configParams) {
    this.configParams = configParams;
    return this;
  }

  public ProvisionVDBByTimestampParameters putConfigParamsItem(String key, Object configParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters privilegedOsUser(String privilegedOsUser) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters postgresPort(Integer postgresPort) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters configSettingsStg(List<ConfigSettingsStg> configSettingsStg) {
    this.configSettingsStg = configSettingsStg;
    return this;
  }

  public ProvisionVDBByTimestampParameters addConfigSettingsStgItem(ConfigSettingsStg configSettingsStgItem) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters vcdbRestart(Boolean vcdbRestart) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters mssqlFailoverDriveLetter(String mssqlFailoverDriveLetter) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public ProvisionVDBByTimestampParameters addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters timestamp(OffsetDateTime timestamp) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters timestampInDatabaseTimezone(String timestampInDatabaseTimezone) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters timeflowId(String timeflowId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters engineId(String engineId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters sourceDataId(String sourceDataId) {
  ...
  **/
  ...
  public ProvisionVDBByTimestampParameters makeCurrentAccountOwner(Boolean makeCurrentAccountOwner) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProvisionVDBByTimestampParameters provisionVDBByTimestampParameters = (ProvisionVDBByTimestampParameters) o;
    return Objects.equals(this.preRefresh, provisionVDBByTimestampParameters.preRefresh) &&
        Objects.equals(this.postRefresh, provisionVDBByTimestampParameters.postRefresh) &&
        Objects.equals(this.preSelfRefresh, provisionVDBByTimestampParameters.preSelfRefresh) &&
        Objects.equals(this.postSelfRefresh, provisionVDBByTimestampParameters.postSelfRefresh) &&
        Objects.equals(this.preRollback, provisionVDBByTimestampParameters.preRollback) &&
        Objects.equals(this.postRollback, provisionVDBByTimestampParameters.postRollback) &&
        Objects.equals(this.configureClone, provisionVDBByTimestampParameters.configureClone) &&
        Objects.equals(this.preSnapshot, provisionVDBByTimestampParameters.preSnapshot) &&
        Objects.equals(this.postSnapshot, provisionVDBByTimestampParameters.postSnapshot) &&
        Objects.equals(this.preStart, provisionVDBByTimestampParameters.preStart) &&
        Objects.equals(this.postStart, provisionVDBByTimestampParameters.postStart) &&
        Objects.equals(this.preStop, provisionVDBByTimestampParameters.preStop) &&
        Objects.equals(this.postStop, provisionVDBByTimestampParameters.postStop) &&
        Objects.equals(this.targetGroupId, provisionVDBByTimestampParameters.targetGroupId) &&
        Objects.equals(this.name, provisionVDBByTimestampParameters.name) &&
        Objects.equals(this.databaseName, provisionVDBByTimestampParameters.databaseName) &&
        Objects.equals(this.cdbId, provisionVDBByTimestampParameters.cdbId) &&
        Objects.equals(this.clusterNodeIds, provisionVDBByTimestampParameters.clusterNodeIds) &&
        Objects.equals(this.clusterNodeInstances, provisionVDBByTimestampParameters.clusterNodeInstances) &&
        Objects.equals(this.truncateLogOnCheckpoint, provisionVDBByTimestampParameters.truncateLogOnCheckpoint) &&
        Objects.equals(this.osUsername, provisionVDBByTimestampParameters.osUsername) &&
        Objects.equals(this.osPassword, provisionVDBByTimestampParameters.osPassword) &&
        Objects.equals(this.environmentId, provisionVDBByTimestampParameters.environmentId) &&
        Objects.equals(this.environmentUserId, provisionVDBByTimestampParameters.environmentUserId) &&
        Objects.equals(this.repositoryId, provisionVDBByTimestampParameters.repositoryId) &&
        Objects.equals(this.autoSelectRepository, provisionVDBByTimestampParameters.autoSelectRepository) &&
        Objects.equals(this.vdbRestart, provisionVDBByTimestampParameters.vdbRestart) &&
        Objects.equals(this.templateId, provisionVDBByTimestampParameters.templateId) &&
        Objects.equals(this.auxiliaryTemplateId, provisionVDBByTimestampParameters.auxiliaryTemplateId) &&
        Objects.equals(this.fileMappingRules, provisionVDBByTimestampParameters.fileMappingRules) &&
        Objects.equals(this.oracleInstanceName, provisionVDBByTimestampParameters.oracleInstanceName) &&
        Objects.equals(this.uniqueName, provisionVDBByTimestampParameters.uniqueName) &&
        Objects.equals(this.vcdbName, provisionVDBByTimestampParameters.vcdbName) &&
        Objects.equals(this.vcdbDatabaseName, provisionVDBByTimestampParameters.vcdbDatabaseName) &&
        Objects.equals(this.mountPoint, provisionVDBByTimestampParameters.mountPoint) &&
        Objects.equals(this.openResetLogs, provisionVDBByTimestampParameters.openResetLogs) &&
        Objects.equals(this.snapshotPolicyId, provisionVDBByTimestampParameters.snapshotPolicyId) &&
        Objects.equals(this.retentionPolicyId, provisionVDBByTimestampParameters.retentionPolicyId) &&
        Objects.equals(this.recoveryModel, provisionVDBByTimestampParameters.recoveryModel) &&
        Objects.equals(this.preScript, provisionVDBByTimestampParameters.preScript) &&
        Objects.equals(this.postScript, provisionVDBByTimestampParameters.postScript) &&
        Objects.equals(this.cdcOnProvision, provisionVDBByTimestampParameters.cdcOnProvision) &&
        Objects.equals(this.onlineLogSize, provisionVDBByTimestampParameters.onlineLogSize) &&
        Objects.equals(this.onlineLogGroups, provisionVDBByTimestampParameters.onlineLogGroups) &&
        Objects.equals(this.archiveLog, provisionVDBByTimestampParameters.archiveLog) &&
        Objects.equals(this.newDbid, provisionVDBByTimestampParameters.newDbid) &&
        Objects.equals(this.masked, provisionVDBByTimestampParameters.masked) &&
        Objects.equals(this.listenerIds, provisionVDBByTimestampParameters.listenerIds) &&
        Objects.equals(this.customEnvVars, provisionVDBByTimestampParameters.customEnvVars) &&
        Objects.equals(this.customEnvFiles, provisionVDBByTimestampParameters.customEnvFiles) &&
        Objects.equals(this.oracleRacCustomEnvFiles, provisionVDBByTimestampParameters.oracleRacCustomEnvFiles) &&
        Objects.equals(this.oracleRacCustomEnvVars, provisionVDBByTimestampParameters.oracleRacCustomEnvVars) &&
        Objects.equals(this.parentTdeKeystorePath, provisionVDBByTimestampParameters.parentTdeKeystorePath) &&
        Objects.equals(this.parentTdeKeystorePassword, provisionVDBByTimestampParameters.parentTdeKeystorePassword) &&
        Objects.equals(this.tdeExportedKeyFileSecret, provisionVDBByTimestampParameters.tdeExportedKeyFileSecret) &&
        Objects.equals(this.tdeKeyIdentifier, provisionVDBByTimestampParameters.tdeKeyIdentifier) &&
        Objects.equals(this.targetVcdbTdeKeystorePath, provisionVDBByTimestampParameters.targetVcdbTdeKeystorePath) &&
        Objects.equals(this.cdbTdeKeystorePassword, provisionVDBByTimestampParameters.cdbTdeKeystorePassword) &&
        Objects.equals(this.vcdbTdeKeyIdentifier, provisionVDBByTimestampParameters.vcdbTdeKeyIdentifier) &&
        Objects.equals(this.appdataSourceParams, provisionVDBByTimestampParameters.appdataSourceParams) &&
        Objects.equals(this.additionalMountPoints, provisionVDBByTimestampParameters.additionalMountPoints) &&
        Objects.equals(this.appdataConfigParams, provisionVDBByTimestampParameters.appdataConfigParams) &&
        Objects.equals(this.configParams, provisionVDBByTimestampParameters.configParams) &&
        Objects.equals(this.privilegedOsUser, provisionVDBByTimestampParameters.privilegedOsUser) &&
        Objects.equals(this.postgresPort, provisionVDBByTimestampParameters.postgresPort) &&
        Objects.equals(this.configSettingsStg, provisionVDBByTimestampParameters.configSettingsStg) &&
        Objects.equals(this.vcdbRestart, provisionVDBByTimestampParameters.vcdbRestart) &&
        Objects.equals(this.mssqlFailoverDriveLetter, provisionVDBByTimestampParameters.mssqlFailoverDriveLetter) &&
        Objects.equals(this.tags, provisionVDBByTimestampParameters.tags) &&
        Objects.equals(this.timestamp, provisionVDBByTimestampParameters.timestamp) &&
        Objects.equals(this.timestampInDatabaseTimezone, provisionVDBByTimestampParameters.timestampInDatabaseTimezone) &&
        Objects.equals(this.timeflowId, provisionVDBByTimestampParameters.timeflowId) &&
        Objects.equals(this.engineId, provisionVDBByTimestampParameters.engineId) &&
        Objects.equals(this.sourceDataId, provisionVDBByTimestampParameters.sourceDataId) &&
        Objects.equals(this.makeCurrentAccountOwner, provisionVDBByTimestampParameters.makeCurrentAccountOwner);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvisionVDBByTimestampParameters {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProvisionVDBByTimestampParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionVDBByTimestampParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisionVDBByTimestampParameters is not found in the empty JSON string", ProvisionVDBByTimestampParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionVDBByTimestampParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisionVDBByTimestampParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProvisionVDBByTimestampParameters.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisionVDBByTimestampParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisionVDBByTimestampParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisionVDBByTimestampParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisionVDBByTimestampParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisionVDBByTimestampParameters>() {
           @Override
           public void write(JsonWriter out, ProvisionVDBByTimestampParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisionVDBByTimestampParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProvisionVDBByTimestampParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProvisionVDBByTimestampParameters
  * @throws IOException if the JSON string is invalid with respect to ProvisionVDBByTimestampParameters
  */
  public static ProvisionVDBByTimestampParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisionVDBByTimestampParameters.class);
  }

 /**
  * Convert an instance of ProvisionVDBByTimestampParameters to an JSON string
  *
  * @return JSON string
  */
