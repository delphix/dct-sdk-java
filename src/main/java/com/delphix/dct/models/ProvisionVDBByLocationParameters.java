...
public class ProvisionVDBByLocationParameters {
  ...
  public ProvisionVDBByLocationParameters() {
  }

  public ProvisionVDBByLocationParameters preRefresh(List<Hook> preRefresh) {
    this.preRefresh = preRefresh;
    return this;
  }

  public ProvisionVDBByLocationParameters addPreRefreshItem(Hook preRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters postRefresh(List<Hook> postRefresh) {
    this.postRefresh = postRefresh;
    return this;
  }

  public ProvisionVDBByLocationParameters addPostRefreshItem(Hook postRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters preSelfRefresh(List<Hook> preSelfRefresh) {
    this.preSelfRefresh = preSelfRefresh;
    return this;
  }

  public ProvisionVDBByLocationParameters addPreSelfRefreshItem(Hook preSelfRefreshItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters postSelfRefresh(List<Hook> postSelfRefresh) {
    this.postSelfRefresh = postSelfRefresh;
    return this;
  }

  public ProvisionVDBByLocationParameters addPostSelfRefreshItem(Hook postSelfRefreshItem) {
  ...
  **/
  ...
  @Deprecated
  public ProvisionVDBByLocationParameters preRollback(List<Hook> preRollback) {
    this.preRollback = preRollback;
    return this;
  }

  public ProvisionVDBByLocationParameters addPreRollbackItem(Hook preRollbackItem) {
  ...
  **/
  ...
  @Deprecated
  public ProvisionVDBByLocationParameters postRollback(List<Hook> postRollback) {
    this.postRollback = postRollback;
    return this;
  }

  public ProvisionVDBByLocationParameters addPostRollbackItem(Hook postRollbackItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters configureClone(List<Hook> configureClone) {
    this.configureClone = configureClone;
    return this;
  }

  public ProvisionVDBByLocationParameters addConfigureCloneItem(Hook configureCloneItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters preSnapshot(List<Hook> preSnapshot) {
    this.preSnapshot = preSnapshot;
    return this;
  }

  public ProvisionVDBByLocationParameters addPreSnapshotItem(Hook preSnapshotItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters postSnapshot(List<Hook> postSnapshot) {
    this.postSnapshot = postSnapshot;
    return this;
  }

  public ProvisionVDBByLocationParameters addPostSnapshotItem(Hook postSnapshotItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters preStart(List<Hook> preStart) {
    this.preStart = preStart;
    return this;
  }

  public ProvisionVDBByLocationParameters addPreStartItem(Hook preStartItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters postStart(List<Hook> postStart) {
    this.postStart = postStart;
    return this;
  }

  public ProvisionVDBByLocationParameters addPostStartItem(Hook postStartItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters preStop(List<Hook> preStop) {
    this.preStop = preStop;
    return this;
  }

  public ProvisionVDBByLocationParameters addPreStopItem(Hook preStopItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters postStop(List<Hook> postStop) {
    this.postStop = postStop;
    return this;
  }

  public ProvisionVDBByLocationParameters addPostStopItem(Hook postStopItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters targetGroupId(String targetGroupId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters databaseName(String databaseName) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters cdbId(String cdbId) {
    this.cdbId = cdbId;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters clusterNodeIds(List<String> clusterNodeIds) {
    this.clusterNodeIds = clusterNodeIds;
    return this;
  }

  public ProvisionVDBByLocationParameters addClusterNodeIdsItem(String clusterNodeIdsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters clusterNodeInstances(List<ClusterNodeInstance> clusterNodeInstances) {
    this.clusterNodeInstances = clusterNodeInstances;
    return this;
  }

  public ProvisionVDBByLocationParameters addClusterNodeInstancesItem(ClusterNodeInstance clusterNodeInstancesItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters truncateLogOnCheckpoint(Boolean truncateLogOnCheckpoint) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters osUsername(String osUsername) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters osPassword(String osPassword) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters environmentId(String environmentId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters environmentUserId(String environmentUserId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters repositoryId(String repositoryId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters autoSelectRepository(Boolean autoSelectRepository) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters vdbRestart(Boolean vdbRestart) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters templateId(String templateId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters auxiliaryTemplateId(String auxiliaryTemplateId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters fileMappingRules(String fileMappingRules) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters oracleInstanceName(String oracleInstanceName) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters uniqueName(String uniqueName) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters vcdbName(String vcdbName) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters vcdbDatabaseName(String vcdbDatabaseName) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters mountPoint(String mountPoint) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters openResetLogs(Boolean openResetLogs) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters snapshotPolicyId(String snapshotPolicyId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters retentionPolicyId(String retentionPolicyId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters recoveryModel(RecoveryModelEnum recoveryModel) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters preScript(String preScript) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters postScript(String postScript) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters cdcOnProvision(Boolean cdcOnProvision) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters onlineLogSize(Integer onlineLogSize) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters onlineLogGroups(Integer onlineLogGroups) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters archiveLog(Boolean archiveLog) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters newDbid(Boolean newDbid) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters masked(Boolean masked) {
    this.masked = masked;
    return this;
  }
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters listenerIds(List<String> listenerIds) {
    this.listenerIds = listenerIds;
    return this;
  }

  public ProvisionVDBByLocationParameters addListenerIdsItem(String listenerIdsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters customEnvVars(Map<String, String> customEnvVars) {
    this.customEnvVars = customEnvVars;
    return this;
  }

  public ProvisionVDBByLocationParameters putCustomEnvVarsItem(String key, String customEnvVarsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters customEnvFiles(List<String> customEnvFiles) {
    this.customEnvFiles = customEnvFiles;
    return this;
  }

  public ProvisionVDBByLocationParameters addCustomEnvFilesItem(String customEnvFilesItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters oracleRacCustomEnvFiles(List<OracleRacCustomEnvFile> oracleRacCustomEnvFiles) {
    this.oracleRacCustomEnvFiles = oracleRacCustomEnvFiles;
    return this;
  }

  public ProvisionVDBByLocationParameters addOracleRacCustomEnvFilesItem(OracleRacCustomEnvFile oracleRacCustomEnvFilesItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters oracleRacCustomEnvVars(List<OracleRacCustomEnvVar> oracleRacCustomEnvVars) {
    this.oracleRacCustomEnvVars = oracleRacCustomEnvVars;
    return this;
  }

  public ProvisionVDBByLocationParameters addOracleRacCustomEnvVarsItem(OracleRacCustomEnvVar oracleRacCustomEnvVarsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters parentTdeKeystorePath(String parentTdeKeystorePath) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters parentTdeKeystorePassword(String parentTdeKeystorePassword) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters tdeExportedKeyFileSecret(String tdeExportedKeyFileSecret) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters tdeKeyIdentifier(String tdeKeyIdentifier) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters targetVcdbTdeKeystorePath(String targetVcdbTdeKeystorePath) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters cdbTdeKeystorePassword(String cdbTdeKeystorePassword) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters vcdbTdeKeyIdentifier(String vcdbTdeKeyIdentifier) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters appdataSourceParams(Map<String, Object> appdataSourceParams) {
    this.appdataSourceParams = appdataSourceParams;
    return this;
  }

  public ProvisionVDBByLocationParameters putAppdataSourceParamsItem(String key, Object appdataSourceParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters additionalMountPoints(List<AdditionalMountPoint> additionalMountPoints) {
    this.additionalMountPoints = additionalMountPoints;
    return this;
  }

  public ProvisionVDBByLocationParameters addAdditionalMountPointsItem(AdditionalMountPoint additionalMountPointsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters appdataConfigParams(Map<String, Object> appdataConfigParams) {
    this.appdataConfigParams = appdataConfigParams;
    return this;
  }

  public ProvisionVDBByLocationParameters putAppdataConfigParamsItem(String key, Object appdataConfigParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters configParams(Map<String, Object> configParams) {
    this.configParams = configParams;
    return this;
  }

  public ProvisionVDBByLocationParameters putConfigParamsItem(String key, Object configParamsItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters privilegedOsUser(String privilegedOsUser) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters postgresPort(Integer postgresPort) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters configSettingsStg(List<ConfigSettingsStg> configSettingsStg) {
    this.configSettingsStg = configSettingsStg;
    return this;
  }

  public ProvisionVDBByLocationParameters addConfigSettingsStgItem(ConfigSettingsStg configSettingsStgItem) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters vcdbRestart(Boolean vcdbRestart) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters mssqlFailoverDriveLetter(String mssqlFailoverDriveLetter) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public ProvisionVDBByLocationParameters addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters location(String location) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters timeflowId(String timeflowId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters engineId(String engineId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters sourceDataId(String sourceDataId) {
  ...
  **/
  ...
  public ProvisionVDBByLocationParameters makeCurrentAccountOwner(Boolean makeCurrentAccountOwner) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProvisionVDBByLocationParameters provisionVDBByLocationParameters = (ProvisionVDBByLocationParameters) o;
    return Objects.equals(this.preRefresh, provisionVDBByLocationParameters.preRefresh) &&
        Objects.equals(this.postRefresh, provisionVDBByLocationParameters.postRefresh) &&
        Objects.equals(this.preSelfRefresh, provisionVDBByLocationParameters.preSelfRefresh) &&
        Objects.equals(this.postSelfRefresh, provisionVDBByLocationParameters.postSelfRefresh) &&
        Objects.equals(this.preRollback, provisionVDBByLocationParameters.preRollback) &&
        Objects.equals(this.postRollback, provisionVDBByLocationParameters.postRollback) &&
        Objects.equals(this.configureClone, provisionVDBByLocationParameters.configureClone) &&
        Objects.equals(this.preSnapshot, provisionVDBByLocationParameters.preSnapshot) &&
        Objects.equals(this.postSnapshot, provisionVDBByLocationParameters.postSnapshot) &&
        Objects.equals(this.preStart, provisionVDBByLocationParameters.preStart) &&
        Objects.equals(this.postStart, provisionVDBByLocationParameters.postStart) &&
        Objects.equals(this.preStop, provisionVDBByLocationParameters.preStop) &&
        Objects.equals(this.postStop, provisionVDBByLocationParameters.postStop) &&
        Objects.equals(this.targetGroupId, provisionVDBByLocationParameters.targetGroupId) &&
        Objects.equals(this.name, provisionVDBByLocationParameters.name) &&
        Objects.equals(this.databaseName, provisionVDBByLocationParameters.databaseName) &&
        Objects.equals(this.cdbId, provisionVDBByLocationParameters.cdbId) &&
        Objects.equals(this.clusterNodeIds, provisionVDBByLocationParameters.clusterNodeIds) &&
        Objects.equals(this.clusterNodeInstances, provisionVDBByLocationParameters.clusterNodeInstances) &&
        Objects.equals(this.truncateLogOnCheckpoint, provisionVDBByLocationParameters.truncateLogOnCheckpoint) &&
        Objects.equals(this.osUsername, provisionVDBByLocationParameters.osUsername) &&
        Objects.equals(this.osPassword, provisionVDBByLocationParameters.osPassword) &&
        Objects.equals(this.environmentId, provisionVDBByLocationParameters.environmentId) &&
        Objects.equals(this.environmentUserId, provisionVDBByLocationParameters.environmentUserId) &&
        Objects.equals(this.repositoryId, provisionVDBByLocationParameters.repositoryId) &&
        Objects.equals(this.autoSelectRepository, provisionVDBByLocationParameters.autoSelectRepository) &&
        Objects.equals(this.vdbRestart, provisionVDBByLocationParameters.vdbRestart) &&
        Objects.equals(this.templateId, provisionVDBByLocationParameters.templateId) &&
        Objects.equals(this.auxiliaryTemplateId, provisionVDBByLocationParameters.auxiliaryTemplateId) &&
        Objects.equals(this.fileMappingRules, provisionVDBByLocationParameters.fileMappingRules) &&
        Objects.equals(this.oracleInstanceName, provisionVDBByLocationParameters.oracleInstanceName) &&
        Objects.equals(this.uniqueName, provisionVDBByLocationParameters.uniqueName) &&
        Objects.equals(this.vcdbName, provisionVDBByLocationParameters.vcdbName) &&
        Objects.equals(this.vcdbDatabaseName, provisionVDBByLocationParameters.vcdbDatabaseName) &&
        Objects.equals(this.mountPoint, provisionVDBByLocationParameters.mountPoint) &&
        Objects.equals(this.openResetLogs, provisionVDBByLocationParameters.openResetLogs) &&
        Objects.equals(this.snapshotPolicyId, provisionVDBByLocationParameters.snapshotPolicyId) &&
        Objects.equals(this.retentionPolicyId, provisionVDBByLocationParameters.retentionPolicyId) &&
        Objects.equals(this.recoveryModel, provisionVDBByLocationParameters.recoveryModel) &&
        Objects.equals(this.preScript, provisionVDBByLocationParameters.preScript) &&
        Objects.equals(this.postScript, provisionVDBByLocationParameters.postScript) &&
        Objects.equals(this.cdcOnProvision, provisionVDBByLocationParameters.cdcOnProvision) &&
        Objects.equals(this.onlineLogSize, provisionVDBByLocationParameters.onlineLogSize) &&
        Objects.equals(this.onlineLogGroups, provisionVDBByLocationParameters.onlineLogGroups) &&
        Objects.equals(this.archiveLog, provisionVDBByLocationParameters.archiveLog) &&
        Objects.equals(this.newDbid, provisionVDBByLocationParameters.newDbid) &&
        Objects.equals(this.masked, provisionVDBByLocationParameters.masked) &&
        Objects.equals(this.listenerIds, provisionVDBByLocationParameters.listenerIds) &&
        Objects.equals(this.customEnvVars, provisionVDBByLocationParameters.customEnvVars) &&
        Objects.equals(this.customEnvFiles, provisionVDBByLocationParameters.customEnvFiles) &&
        Objects.equals(this.oracleRacCustomEnvFiles, provisionVDBByLocationParameters.oracleRacCustomEnvFiles) &&
        Objects.equals(this.oracleRacCustomEnvVars, provisionVDBByLocationParameters.oracleRacCustomEnvVars) &&
        Objects.equals(this.parentTdeKeystorePath, provisionVDBByLocationParameters.parentTdeKeystorePath) &&
        Objects.equals(this.parentTdeKeystorePassword, provisionVDBByLocationParameters.parentTdeKeystorePassword) &&
        Objects.equals(this.tdeExportedKeyFileSecret, provisionVDBByLocationParameters.tdeExportedKeyFileSecret) &&
        Objects.equals(this.tdeKeyIdentifier, provisionVDBByLocationParameters.tdeKeyIdentifier) &&
        Objects.equals(this.targetVcdbTdeKeystorePath, provisionVDBByLocationParameters.targetVcdbTdeKeystorePath) &&
        Objects.equals(this.cdbTdeKeystorePassword, provisionVDBByLocationParameters.cdbTdeKeystorePassword) &&
        Objects.equals(this.vcdbTdeKeyIdentifier, provisionVDBByLocationParameters.vcdbTdeKeyIdentifier) &&
        Objects.equals(this.appdataSourceParams, provisionVDBByLocationParameters.appdataSourceParams) &&
        Objects.equals(this.additionalMountPoints, provisionVDBByLocationParameters.additionalMountPoints) &&
        Objects.equals(this.appdataConfigParams, provisionVDBByLocationParameters.appdataConfigParams) &&
        Objects.equals(this.configParams, provisionVDBByLocationParameters.configParams) &&
        Objects.equals(this.privilegedOsUser, provisionVDBByLocationParameters.privilegedOsUser) &&
        Objects.equals(this.postgresPort, provisionVDBByLocationParameters.postgresPort) &&
        Objects.equals(this.configSettingsStg, provisionVDBByLocationParameters.configSettingsStg) &&
        Objects.equals(this.vcdbRestart, provisionVDBByLocationParameters.vcdbRestart) &&
        Objects.equals(this.mssqlFailoverDriveLetter, provisionVDBByLocationParameters.mssqlFailoverDriveLetter) &&
        Objects.equals(this.tags, provisionVDBByLocationParameters.tags) &&
        Objects.equals(this.location, provisionVDBByLocationParameters.location) &&
        Objects.equals(this.timeflowId, provisionVDBByLocationParameters.timeflowId) &&
        Objects.equals(this.engineId, provisionVDBByLocationParameters.engineId) &&
        Objects.equals(this.sourceDataId, provisionVDBByLocationParameters.sourceDataId) &&
        Objects.equals(this.makeCurrentAccountOwner, provisionVDBByLocationParameters.makeCurrentAccountOwner);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProvisionVDBByLocationParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionVDBByLocationParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisionVDBByLocationParameters is not found in the empty JSON string", ProvisionVDBByLocationParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionVDBByLocationParameters.openapiFields.contains(entry.getKey())) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisionVDBByLocationParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisionVDBByLocationParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisionVDBByLocationParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisionVDBByLocationParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisionVDBByLocationParameters>() {
           @Override
           public void write(JsonWriter out, ProvisionVDBByLocationParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisionVDBByLocationParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProvisionVDBByLocationParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProvisionVDBByLocationParameters
  * @throws IOException if the JSON string is invalid with respect to ProvisionVDBByLocationParameters
  */
  public static ProvisionVDBByLocationParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisionVDBByLocationParameters.class);
  }

 /**
  * Convert an instance of ProvisionVDBByLocationParameters to an JSON string
  *
  * @return JSON string
  */
