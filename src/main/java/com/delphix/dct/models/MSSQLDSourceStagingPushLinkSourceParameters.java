...
public class MSSQLDSourceStagingPushLinkSourceParameters {
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters() {
  }

  public MSSQLDSourceStagingPushLinkSourceParameters name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters sourceId(String sourceId) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters groupId(String groupId) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters description(String description) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters logSyncEnabled(Boolean logSyncEnabled) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters syncPolicyId(String syncPolicyId) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters retentionPolicyId(String retentionPolicyId) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters makeCurrentAccountOwner(Boolean makeCurrentAccountOwner) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters tags(List<Tag> tags) {
    this.tags = tags;
    return this;
  }

  public MSSQLDSourceStagingPushLinkSourceParameters addTagsItem(Tag tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters opsPreSync(List<SourceOperation> opsPreSync) {
    this.opsPreSync = opsPreSync;
    return this;
  }

  public MSSQLDSourceStagingPushLinkSourceParameters addOpsPreSyncItem(SourceOperation opsPreSyncItem) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters opsPostSync(List<SourceOperation> opsPostSync) {
    this.opsPostSync = opsPostSync;
    return this;
  }

  public MSSQLDSourceStagingPushLinkSourceParameters addOpsPostSyncItem(SourceOperation opsPostSyncItem) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters engineId(String engineId) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters encryptionKey(String encryptionKey) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters pptRepository(String pptRepository) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters pptHostUser(String pptHostUser) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters stagingPreScript(String stagingPreScript) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters stagingPostScript(String stagingPostScript) {
  ...
  **/
  ...
  public MSSQLDSourceStagingPushLinkSourceParameters stagingDatabaseName(String stagingDatabaseName) {
  ...
  **/
  ...
  public void setStagingDatabaseName(String stagingDatabaseName) {
    this.stagingDatabaseName = stagingDatabaseName;
  }
  ...
  public boolean equals(Object o) {
    ...
    MSSQLDSourceStagingPushLinkSourceParameters msSQLDSourceStagingPushLinkSourceParameters = (MSSQLDSourceStagingPushLinkSourceParameters) o;
    return Objects.equals(this.name, msSQLDSourceStagingPushLinkSourceParameters.name) &&
        Objects.equals(this.sourceId, msSQLDSourceStagingPushLinkSourceParameters.sourceId) &&
        Objects.equals(this.groupId, msSQLDSourceStagingPushLinkSourceParameters.groupId) &&
        Objects.equals(this.description, msSQLDSourceStagingPushLinkSourceParameters.description) &&
        Objects.equals(this.logSyncEnabled, msSQLDSourceStagingPushLinkSourceParameters.logSyncEnabled) &&
        Objects.equals(this.syncPolicyId, msSQLDSourceStagingPushLinkSourceParameters.syncPolicyId) &&
        Objects.equals(this.retentionPolicyId, msSQLDSourceStagingPushLinkSourceParameters.retentionPolicyId) &&
        Objects.equals(this.makeCurrentAccountOwner, msSQLDSourceStagingPushLinkSourceParameters.makeCurrentAccountOwner) &&
        Objects.equals(this.tags, msSQLDSourceStagingPushLinkSourceParameters.tags) &&
        Objects.equals(this.opsPreSync, msSQLDSourceStagingPushLinkSourceParameters.opsPreSync) &&
        Objects.equals(this.opsPostSync, msSQLDSourceStagingPushLinkSourceParameters.opsPostSync) &&
        Objects.equals(this.engineId, msSQLDSourceStagingPushLinkSourceParameters.engineId) &&
        Objects.equals(this.encryptionKey, msSQLDSourceStagingPushLinkSourceParameters.encryptionKey) &&
        Objects.equals(this.pptRepository, msSQLDSourceStagingPushLinkSourceParameters.pptRepository) &&
        Objects.equals(this.pptHostUser, msSQLDSourceStagingPushLinkSourceParameters.pptHostUser) &&
        Objects.equals(this.stagingPreScript, msSQLDSourceStagingPushLinkSourceParameters.stagingPreScript) &&
        Objects.equals(this.stagingPostScript, msSQLDSourceStagingPushLinkSourceParameters.stagingPostScript) &&
        Objects.equals(this.stagingDatabaseName, msSQLDSourceStagingPushLinkSourceParameters.stagingDatabaseName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, sourceId, groupId, description, logSyncEnabled, syncPolicyId, retentionPolicyId, makeCurrentAccountOwner, tags, opsPreSync, opsPostSync, engineId, encryptionKey, pptRepository, pptHostUser, stagingPreScript, stagingPostScript, stagingDatabaseName);
  }
  ...
  public String toString() {
    ...
    sb.append("    stagingDatabaseName: ").append(toIndentedString(stagingDatabaseName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("staging_database_name");
    ...
    openapiRequiredFields.add("staging_database_name");
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to MSSQLDSourceStagingPushLinkSourceParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MSSQLDSourceStagingPushLinkSourceParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MSSQLDSourceStagingPushLinkSourceParameters is not found in the empty JSON string", MSSQLDSourceStagingPushLinkSourceParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MSSQLDSourceStagingPushLinkSourceParameters.openapiFields.contains(entry.getKey())) {
      ...
      for (String requiredField : MSSQLDSourceStagingPushLinkSourceParameters.openapiRequiredFields) {
      ...
      if (!jsonObj.get("ppt_repository").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("ppt_host_user").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("staging_database_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `staging_database_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("staging_database_name").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MSSQLDSourceStagingPushLinkSourceParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MSSQLDSourceStagingPushLinkSourceParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MSSQLDSourceStagingPushLinkSourceParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MSSQLDSourceStagingPushLinkSourceParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<MSSQLDSourceStagingPushLinkSourceParameters>() {
           @Override
           public void write(JsonWriter out, MSSQLDSourceStagingPushLinkSourceParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MSSQLDSourceStagingPushLinkSourceParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MSSQLDSourceStagingPushLinkSourceParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MSSQLDSourceStagingPushLinkSourceParameters
  * @throws IOException if the JSON string is invalid with respect to MSSQLDSourceStagingPushLinkSourceParameters
  */
  public static MSSQLDSourceStagingPushLinkSourceParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MSSQLDSourceStagingPushLinkSourceParameters.class);
  }

 /**
  * Convert an instance of MSSQLDSourceStagingPushLinkSourceParameters to an JSON string
  *
  * @return JSON string
  */
