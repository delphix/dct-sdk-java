...
public class HyperscaleMountPointUpdateParameters {
  ...
  public HyperscaleMountPointUpdateParameters() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to HyperscaleMountPointUpdateParameters
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HyperscaleMountPointUpdateParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HyperscaleMountPointUpdateParameters is not found in the empty JSON string", HyperscaleMountPointUpdateParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HyperscaleMountPointUpdateParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HyperscaleMountPointUpdateParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("mount_type") != null && !jsonObj.get("mount_type").isJsonNull()) && !jsonObj.get("mount_type").isJsonPrimitive()) {
      ...
      // validate the optional field `mount_type`
      if (jsonObj.get("mount_type") != null && !jsonObj.get("mount_type").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HyperscaleMountPointUpdateParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HyperscaleMountPointUpdateParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HyperscaleMountPointUpdateParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HyperscaleMountPointUpdateParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<HyperscaleMountPointUpdateParameters>() {
           @Override
           public void write(JsonWriter out, HyperscaleMountPointUpdateParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HyperscaleMountPointUpdateParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of HyperscaleMountPointUpdateParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HyperscaleMountPointUpdateParameters
  * @throws IOException if the JSON string is invalid with respect to HyperscaleMountPointUpdateParameters
  */
  public static HyperscaleMountPointUpdateParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HyperscaleMountPointUpdateParameters.class);
  }

 /**
  * Convert an instance of HyperscaleMountPointUpdateParameters to an JSON string
  *
  * @return JSON string
  */
