 ...
 */
@ApiModel(description = "A repository corresponding to the environment.")
...
public class EnvironmentRepository {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The environment ID.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, databaseType, allowProvisioning, isStaging, oracleBase, version, bits, installGroup, installUser, rac, ports, dumpHistoryFile, pageSize, owner, installationPath, fulltextInstalled, internalVersion, mssqlClusterInstancesName, mssqlClusterInstancesVersion, installationHome, environmentId);
  }
